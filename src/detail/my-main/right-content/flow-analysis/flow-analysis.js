                            ...
                            <div className="form-right">
                                ...
                                <li className="validTime">
                                    <button className={0 === this.state.flagValidTime ? 'active' : null}
                                            onClick={(e) => this.seleValidTime(e, 0)}>半年
                                    </button>
                                    <button className={1 === this.state.flagValidTime ? 'active' : null}
                                            onClick={(e) => this.seleValidTime(e, 1)}>一年
                                    </button>
                                    <button className={2 === this.state.flagValidTime ? 'active' : null}
                                            onClick={(e) => this.seleValidTime(e, 2)}>三年
                                    </button>
                                </li>
                                <li className="version">
                                    <button className={0 === this.state.flagVersion ? 'active' : null}
                                            onClick={(e) => this.seleVersion(e, 0)}>客户版
                                    </button>
                                    <button className={1 === this.state.flagVersion ? 'active' : null}
                                            onClick={(e) => this.seleVersion(e, 1)}>代理商版
                                    </button>
                                    <button className={2 === this.state.flagVersion ? 'active' : null}
                                            onClick={(e) => this.seleVersion(e, 2)}>专家版
                                    </button>
                                </li>
