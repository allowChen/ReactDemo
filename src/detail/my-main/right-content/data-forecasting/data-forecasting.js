                    ...
                    <div className="DF-right-top">
                        ...
                        <div className="right-top-form">
                            ...
                            <div className="form-right">
                                ...
                                <li className="medium">
                                    <button className={0 === this.state.flag ? 'active' : null}
                                            onClick={(e) => this.sele(e, 0)}>纸质报告
                                    </button>
                                    <button className={1 === this.state.flag ? 'active' : null}
                                            onClick={(e) => this.sele(e, 1)}>pdf
                                    </button>
                                    <button className={2 === this.state.flag ? 'active' : null}
                                            onClick={(e) => this.sele(e, 2)}>页面报告
                                    </button>
                                    <button className={3 === this.state.flag ? 'active' : null}
                                            onClick={(e) => this.sele(e, 3)}>邮件
                                    </button>
                                </li>
